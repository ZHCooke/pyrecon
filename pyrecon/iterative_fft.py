...
class First_HybridIterativeFFTReconstruction(IterativeFFTReconstruction):
    """
    Implementation of Burden et al. 2015 (https://arxiv.org/abs/1504.02591)
    field-level (as opposed to :class:`IterativeFFTParticleReconstruction`) algorithm.
    """
...
class Second_HybridIterativeFFTReconstruction(IterativeFFTReconstruction):
    """
    Implementation of Burden et al. 2015 (https://arxiv.org/abs/1504.02591)
    field-level (as opposed to :class:`IterativeFFTParticleReconstruction`) algorithm.
    """
...
class Third_HybridIterativeFFTReconstruction(IterativeFFTReconstruction):
    """
